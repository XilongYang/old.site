...
function RunXinux() {
    ...
    loader.addEventListener('animationend', function(){
        window.location.replace("/old.site/components/xinux/bin/xiell");
    });
}
...
var menuEntrys = [ 
    new Entry(new Icon(IconTemplate.IMG, "/old.site/res/xinux.svg"), EntryTemplate.SELECTED, "Run Xinux"

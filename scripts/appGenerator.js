...
function appGenerate() {
    ...
    , '<iframe class="fake_window_contents" id="music-content" loading="lazy" src="/old.site/components/musicplayer/" frameborder="0"></iframe>'
    , "<i class='material-icons'>album</i>", "icons_tray_tools");

    new Application("xinux", "Xinux"
    , '<iframe class="fake_window_contents non_dark" id="terminal-content" loading="lazy" src="/old.site/components/xinux/boot/bootloader" frameborder="0"></iframe>'
    , "<i class='material-icons'>terminal</i>", "icons_tray_tools");

    new Application("blog", "Xilong's Blog"
    , '<iframe class="fake_window_contents non_dark" id="blog" loading="lazy" src="/old.site/blog/" frameborder="0"></iframe>'
